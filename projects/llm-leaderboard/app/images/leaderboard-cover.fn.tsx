...
export type LeaderboardCoverProps = z.infer<typeof propsSchema>;

export const previewProps: LeaderboardCoverProps = {
  title: TITLE,
};
...
export async function runner({
  props: { title },
  bounds: { width, height },
}: RunnerArgs<LeaderboardCoverProps>): ImageRunnerReturn {
