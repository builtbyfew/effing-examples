...
type Module = typeof import("../preview.image.$imageId[.bytes].js")

type Info = GetInfo<{
  file: "routes/preview.image.$imageId[.bytes].tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../preview.image.$imageId[.bytes].js");
}];
