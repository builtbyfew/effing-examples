...
/**
 * Rye Regular (400) — western/saloon display
 */
export const rye: Font = async () => ({
  name: "Rye",
  data: await fetchFont(`${GOOGLE_FONTS_BASE}/rye/v17/r05XGLJT86YDFg.ttf`),
  weight: 400,
  style: "normal",
});

/**
 * IM Fell English SC Regular (400) — old-style serif small caps
 */
export const imFellEnglishSC: Font = async () => ({
  name: "IM Fell English SC",
  data: await fetchFont(
    `${GOOGLE_FONTS_BASE}/imfellenglishsc/v16/a8IENpD3CDX-4zrWfr1VY879qFF05pZLOw.ttf`,
  ),
  weight: 400,
  style: "normal",
});
